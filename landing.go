...
<title>Things Cloud MCP - Connect Your AI to Things 3</title>
<meta name="description" content="A Model Context Protocol server that gives AI assistants like Claude, ChatGPT, and Cursor full access to Things 3 task management through Things Cloud. OAuth 2.0, Streamable HTTP, 23 tools.">
<link rel="canonical" href="https://thingscloudmcp.com/">
<meta property="og:type" content="website">
<meta property="og:site_name" content="Things Cloud MCP">
<meta property="og:title" content="Things Cloud MCP - Connect Your AI to Things 3">
<meta property="og:description" content="A Model Context Protocol server that gives AI assistants like Claude, ChatGPT, and Cursor full access to Things 3 task management through Things Cloud.">
<meta property="og:url" content="https://thingscloudmcp.com/">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="Things Cloud MCP - Connect Your AI to Things 3">
<meta name="twitter:description" content="A Model Context Protocol server that gives AI assistants like Claude, ChatGPT, and Cursor full access to Things 3 task management through Things Cloud.">
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebApplication","name":"Things Cloud MCP","url":"https://thingscloudmcp.com/","description":"A Model Context Protocol server that gives AI assistants full access to Things 3 task management through Things Cloud.","applicationCategory":"DeveloperApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}
</script>
<style>
` + sharedCSS + `
</style>
...
<header>
  <div class="container header-inner">
    ...
    <nav class="header-right" aria-label="Main navigation">
      ...
      <span class="header-divider">|</span>
      <a class="github-link" href="https://github.com/wbopan/things-cloud-mcp" target="_blank" rel="noopener" title="GitHub"><svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg></a>
    </nav>
  </div>
</header>
...
<link rel="icon" type="image/png" sizes="32x32" href="/favicon.ico">
<link rel="icon" type="image/svg+xml" href="/favicon.svg">
<title>API Documentation - Things Cloud MCP</title>
<meta name="description" content="Complete API reference for all 23 tools in Things Cloud MCP. Read, create, edit, and manage Things 3 tasks, projects, areas, tags, and checklists through MCP.">
<link rel="canonical" href="https://thingscloudmcp.com/docs">
<meta property="og:type" content="article">
<meta property="og:site_name" content="Things Cloud MCP">
<meta property="og:title" content="API Documentation - Things Cloud MCP">
<meta property="og:description" content="Complete API reference for all 23 tools in Things Cloud MCP. Read, create, edit, and manage Things 3 tasks, projects, areas, tags, and checklists.">
<meta property="og:url" content="https://thingscloudmcp.com/docs">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="API Documentation - Things Cloud MCP">
<meta name="twitter:description" content="Complete API reference for all 23 tools in Things Cloud MCP. Read, create, edit, and manage Things 3 tasks, projects, areas, tags, and checklists.">
<style>
` + sharedCSS + `
...
<div class="docs-section">
  ...
  <div class="tool-entry">
    ...
    <div class="tool-entry-desc">Show all raw wire-format fields of a task or project. Accepts a UUID prefix.</div>
    <table class="params-table">
      <tr><th>Parameter</th><th>Type</th><th>Description</th></tr>
      <tr><td><span class="param-name">uuid</span><span class="param-required">required</span></td><td class="param-type">string</td><td>Task or project UUID, or unique prefix</td></tr>
    </table>
  </div>
...
<div class="docs-section">
  ...
  <div class="tool-entry">
    ...
    <table class="params-table">
      ...
      <tr><td><span class="param-name">schedule</span></td><td class="param-type">string</td><td>today, anytime (default), someday, or YYYY-MM-DD</td></tr>
      <tr><td><span class="param-name">deadline</span></td><td class="param-type">string</td><td>YYYY-MM-DD</td></tr>
      <tr><td><span class="param-name">area_uuid</span></td><td class="param-type">string</td><td>Assign to area</td></tr>
      <tr><td><span class="param-name">tags</span></td><td class="param-type">string</td><td>Comma-separated tag UUIDs</td></tr>
      <tr><td><span class="param-name">reminder_date</span></td><td class="param-type">string</td><td>YYYY-MM-DD (use with reminder_time)</td></tr>
...
<meta name="description" content="Learn how Things Cloud MCP connects your AI assistant to Things 3 from anywhere by talking directly to Things Cloud, the sync service behind your Apple devices.">
<link rel="canonical" href="https://thingscloudmcp.com/how-it-works">
<meta property="og:type" content="article">
<meta property="og:site_name" content="Things Cloud MCP">
<meta property="og:title" content="How it Works - Things Cloud MCP">
<meta property="og:description" content="Learn how Things Cloud MCP connects your AI assistant to Things 3 from anywhere by talking directly to Things Cloud.">
<meta property="og:url" content="https://thingscloudmcp.com/how-it-works">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="How it Works - Things Cloud MCP">
<meta name="twitter:description" content="Learn how Things Cloud MCP connects your AI assistant to Things 3 from anywhere by talking directly to Things Cloud.">
<style>
` + sharedCSS + `
